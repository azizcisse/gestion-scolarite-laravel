<div class="mt-5">
    <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-4">
        ...
        <div class="flex justify-between items-center">
            ...
            <a href="{{ route('parent_eleves.create_parent_eleve') }}"
                class="bg-blue-500 rounded-md p-2 text-sm text-white">Enregistrer Un Parent</a>
        </div>
                    ...
                    <table class="min-w-full text-center">
                        <thead class="border-b bg-gray-50">
                            <tr>
                                ...
                                <th class="text-sm font-medium text-gray-900 px-6 py-6">Adresse Email</th>
                            ...
                            @forelse ($listParent
                             as $item)
                                <tr class="border-b-1 border-gray-100">
                                    ...
                                    <td class="text-sm font-medium text-gray-900 px-6 py-6">{{ $item->telephone }}</td>
                                    <td>
