        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-jet-nav-link href="{{ route('parent_eleves') }}" :active="request()->routeIs('parent_eleves')">
                        {{ __('Parents') }}
                    </x-jet-nav-link>

                    <x-jet-nav-link href="{{ route('eleves') }}" :active="request()->routeIs('eleves')">
                        {{ __('Elèves') }}
                    </x-jet-nav-link>
                    ...
                    <x-jet-nav-link href="{{ route('paiements') }}" :active="request()->routeIs('paiements')">
                        {{ __('Paiements') }}
                    </x-jet-nav-link>

                     <x-jet-nav-link href="{{ route('frais_scolarites') }}" :active="request()->routeIs('frais_scolarites')">
